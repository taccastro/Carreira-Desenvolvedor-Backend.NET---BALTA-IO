...
namespace DatesSample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var timezoneBrazilTime = TimeZoneInfo.FindSystemTimeZoneById("E. South America Standard Time");
            var HoraBrasil = TimeZoneInfo.ConvertTimeFromUtc(dateTime, timezoneBrazilTime);
            Console.WriteLine(HoraBrasil);
